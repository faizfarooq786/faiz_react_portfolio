...
const projectsHeader = {
  title: "Projects",
  description:
    "My projects makes use of vast variety of latest technology tools. My best experience is to create website projects. Below are some of my projects. Some of my projects are also uploaded on my GitHub.",
